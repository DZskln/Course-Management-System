...
<body>
	<div class="navContainer">
		<nav class="NavBar">
			...
			// // this code is added by Rafie, to show the page name in the nav
			...
			// end of the code added by Rafie
		...
		<div class="heroSubContainer">
			...
			if (isset($_SESSION["type"], $_SESSION["module"], $_SESSION["id_module"])) { // check first if the information exist in the session to execute the script
				...
				if (!$result) {
					...
					// this code is commented by Rafie, because it has showed yet in the navbar
